  ...
  return (
    <Fragment>
        <div className='shadow-md flex justify-between items-center rounded-2xl p-3'>
            <div>
                <div className='text-lg font-bold text-start flex gap-1 items-center'>
                ...
                <div className='flex gap-2 text-start text-gray-400 font-medium'>
        ...
        <div className='flex justify-between items-center my-3'>
            <div className='text-start py-2'>
                <h3 className='text-2xl font-medium text-orange-400'>Choose departure flight</h3>
                <span className='text-gray-400 font-normal'>50 Search results</span>
            </div>
            <div className='flex items-center gap-2'>
            <h3 className='text-base text-gray-400'>Sort by price</h3>
            <Select
                defaultValue="low"
                style={{ width: 130 }}
